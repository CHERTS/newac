...
begin
  ...
  TRateConverter, TAudioProcessor, TMSResampler, TBWFilter, TSincFilter, TStereoBalance, TResampler, TDitherer, TAudioPass, TNormalizer, TVoiceFilter, TFrequencyAnalysis, TConvolver, TDifferenceEquation]);
