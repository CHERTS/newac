...
var
  ...
  b : Boolean;
begin
  // Call to Input.GetData(Buffer, Bytes)
  //  retrieves a part of the input component's buffer (pointed to by Buffer)
  // that contains The number of bytes returned in Bytes.
  // See the Component Writers Guide on more detail about how GetData() operates.
  ...
  // ...otherwise convert stereo to mono.
    ...
    // EndOfInput is set to True when FillBuffer has encountered the end of data
    // in AudioProcessor1.Input. There still may be some data in the input,
    // but the next time this method is called we should return nil.
