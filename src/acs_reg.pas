...
uses
  ...
  NewACDTS, NewACAC3, NewACIndicators, NewACDSAudio;
...
begin
  ...
  RegisterComponents('Audio Utilities',  [TCDPlayer, TNULLOut, TAudioHiResTimer, TAudioSynchronizer, TCDDBInfo, TCueSplitter, TGainIndicator, TFastGainIndicator, TSpectrumIndicator, TTagEditor, TAudioCache]);
end;
